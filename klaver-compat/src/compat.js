...
let createIterator;
if (Symbol?.iterator && typeof [][Symbol.iterator] === "function") {
...
class Response extends Body {
    ...
    constructor(body, init = {}) {
        super(body && body instanceof Response$1
            ? body.stream()
            : new ReadableStream());
...
function init$1(global) {
    Object.defineProperties(global, {
        ReadableStream: { value: ReadableStream$1 },
        WritableStream: { value: WritableStream },
        TransformStream: { value: TransformStream$1 },
