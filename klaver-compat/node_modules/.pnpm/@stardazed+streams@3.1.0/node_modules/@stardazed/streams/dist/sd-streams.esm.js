    ...
    switch (valueType) {
        ...
        case "object": {
            ...
            if (value instanceof ArrayBuffer) {
                const cloned = cloneArrayBuffer(value, 0, value.byteLength);
...
function createControlledPromise() {
    ...
    conProm.promise = new Promise(function (resolve, reject) {
        conProm.resolve = function (v) { conProm.state = 1; resolve(v); };
        conProm.reject = function (e) { conProm.state = 2; reject(e); };
    });
    return conProm;
}
...
export { ByteLengthQueuingStrategy, CountQueuingStrategy, SDReadableStream as ReadableStream, TransformStream, WritableStream, createReadableByteStream as internal_createReadableByteStream, createReadableStream as internal_createReadableStream, readableStreamTee as internal_readableStreamTee };
