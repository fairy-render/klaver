...
impl Typings {
    ...
    pub fn files(&self) -> geenie::FileList {
        ...
        files.push(geenie::File {
            path: relative_path::RelativePathBuf::from("globals.d.ts"),
